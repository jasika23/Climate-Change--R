...
The primary aim of this assignment is to conduct a comprehensive analysis of the Global Land Temperature Anomalies dataset and develop ARIMA models for forecasting future temperature variations. Specific objectives include:
...
Artifical tools like chatgpt and quillbot were used to help me capture my observations and report them using gramatically correct English in a formal manner.

They also helped me understand some testings like the ML and CSS for ARIMA model selection.
...
4.  <https://bookdown.org/JakeEsprabens/431-Time-Series/introduction-to-time-series.html#components-of-time-series>
